...
// 609-610
        ...
        a.add("INSERT INTO `parameter` (`system`, `param`, `value`, `description`) VALUES "
                + "('', 'cerberus_automaticqueuecancellationjob_period', '60', 'Period of time in minutes between each job that will cancel old queue entries that are still running.')"
        ...
        b.append("  `ExeID` bigint(20) unsigned NULL,");
        b.append("  `UsrCreated` varchar(45) NOT NULL DEFAULT '',");
        b.append("  `DateCreated` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,");
        b.append("  `UsrModif` varchar(45) NOT NULL DEFAULT '',");
        b.append("  `DateModif` timestamp NOT NULL DEFAULT '1970-01-01 01:01:01',");
        ...
        // 1397
        a.add("INSERT INTO `parameter` (`system`,`param`, `value`, `description`) VALUES ('','cerberus_selenium_autoscroll', 'N', 'Boolean (Y/N) that define if Cerberus automatically scroll the current page on any element it interact with.'); ");
        ...
        a.add("CREATE TABLE `dashboardconfig` ("
                ...
                + "`title` varchar(50) NOT NULL DEFAULT 'CURRENT',"
                ...
                + "UNIQUE(`usr_id`,`title`),"
                + "CONSTRAINT `FK_dashboardconf_01` FOREIGN KEY (`usr_id`) REFERENCES `user` (`UserID`) ON DELETE CASCADE ON UPDATE CASCADE"
                + ") ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;");
        ...
        a.add("CREATE TABLE `dashboardgroup` ("
                ...
                + "CONSTRAINT `FK_dashboardgroup_01` FOREIGN KEY (`id_config`) REFERENCES `dashboardconfig` (`id_config`) ON DELETE CASCADE ON UPDATE CASCADE,"
