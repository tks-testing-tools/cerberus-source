...
public enum MessageEventEnum {
    ...
    ACTION_FAILED_CALLSERVICE_SEEKKAFKA(286, "FA", "Failed to seek the kafka topic '%TOPIC%'. %EX%", true, true, false, MessageGeneralEnum.EXECUTION_FA_ACTION),
    ACTION_FAILED_CALLSERVICE_SEARCHKAFKA(286, "FA", "Failed to search the kafka topic '%TOPIC%'. %EX%", true, true, false, MessageGeneralEnum.EXECUTION_FA_ACTION),
    ...
    ACTION_FAILED_SIKULI_SERVER_BADURL(289, "FA", "Sikuli Server is not reachable at %URL%. Please verify the url parameters.", true, true, false, MessageGeneralEnum.EXECUTION_FA_ACTION),
    ...
    ACTION_FAILED_EXECUTECOMMAND(297, "FA", "Not executed because Action : %EXCEPTION%. Missing file on the server or command not supported", true, true, true, MessageGeneralEnum.EXECUTION_FA_ACTION),
    ...
    CONTROL_SUCCESS_EQUAL(300, "OK", "'%STRING1%' is equal to '%STRING2%' with case sensitive constraint : '%STRING3%'.", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    CONTROL_SUCCESS_CONTAINS(300, "OK", "'%STRING1%' contains '%STRING2%' with case sensitive constraint : '%STRING3%'.", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    CONTROL_SUCCESS_NOTCONTAINS(300, "OK", "'%STRING1%' does not contains '%STRING2%' with case sensitive constraint : '%STRING3%'.", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    CONTROL_SUCCESS_DIFFERENT(300, "OK", "'%STRING1%' is different from '%STRING2%' with case sensitive constraint : '%STRING3%'.", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    ...
    CONTROL_SUCCESS_TEXTINELEMENT(300, "OK", "Element '%STRING1%' with value '%STRING2%' is equal to '%STRING3%' with case sensitive constraint : '%STRING4%'.", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    CONTROL_SUCCESS_TEXTNOTINELEMENT(300, "OK", "Element '%STRING1%' with value '%STRING2%' is different than '%STRING3%' with case sensitive constraint : '%STRING4%'.", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    ...
    CONTROL_SUCCESS_TITLE(300, "OK", "Current title '%STRING1%' is equal to '%STRING2%' with case sensitive constraint : '%STRING3%'", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    ...
    CONTROL_FAILED_EQUAL(357, "KO", "'%STRING1%' is not equal to '%STRING2%' with case sensitive constraint : '%STRING3%'.", true, true, false, MessageGeneralEnum.EXECUTION_KO),
    CONTROL_FAILED_DIFFERENT(358, "KO", "'%STRING1%' is not different from '%STRING2%' with case sensitive constraint : '%STRING3%'.", true, true, false, MessageGeneralEnum.EXECUTION_KO),
    ...
    CONTROL_FAILED_TEXTINELEMENT(367, "KO", "Element '%STRING1%' with value '%STRING2%' is not equal to '%STRING3%' with case sensitive constraint : '%STRING3%'.", true, true, true, MessageGeneralEnum.EXECUTION_KO),
    ...
    CONTROL_FAILED_TEXTNOTINELEMENT(367, "KO", "Element '%STRING1%' with value '%STRING2%' is not different than '%STRING3%' with case sensitive constraint : '%STRING4%'.", true, true, true, MessageGeneralEnum.EXECUTION_KO),
    ...
    CONTROL_FAILED_TITLE(373, "KO", "Current title '%STRING1%' is not equal to '%STRING2%' with case sensitive constraint : '%STRING3%'", true, true, true, MessageGeneralEnum.EXECUTION_KO),
    ...
    CONTROL_FAILED_CONTAINS(382, "KO", "'%STRING1%' does not contain '%STRING2%' with case sensitive constraint : '%STRING3%'.", true, true, false, MessageGeneralEnum.EXECUTION_KO),
    CONTROL_FAILED_NOTCONTAINS(382, "KO", "'%STRING1%' contain '%STRING2%' with case sensitive constraint : '%STRING3%'.", true, true, false, MessageGeneralEnum.EXECUTION_KO),
    ...
    CONDITIONEVAL_FAILED_NOOBJECTINMEMORY(1220, "FA", "Cannot perform the control because no successfull Service/Page/Screen was accessed previously.", false, false, false, MessageGeneralEnum.EXECUTION_FA_CONDITION),
    ...
    CONDITIONEVAL_FALSE_STRINGCONTAINS(1210, "NA", "'%STR1%' does contain '%STR2%'", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    CONDITIONEVAL_FALSE_STRINGNOTCONTAINS(1210, "NA", "'%STR1%' contain '%STR2%'", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    ...
    CONDITIONEVAL_TRUE_STRINGCONTAINS(1210, "OK", "'%STR1%' does not contain '%STR2%'", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    CONDITIONEVAL_TRUE_STRINGNOTCONTAINS(1210, "OK", "'%STR1%' does not contain '%STR2%'", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    ...
    CONDITIONEVAL_TRUE_TEXTINELEMENT(300, "OK", "Element '%STRING1%' with value '%STRING2%' is equal to '%STRING3%'.", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    CONDITIONEVAL_TRUE_TEXTNOTINELEMENT(300, "OK", "Element '%STRING1%' with value '%STRING2%' is different than '%STRING3%'.", false, false, false, MessageGeneralEnum.EXECUTION_PE_TESTSTARTED),
    ...
    DASHBOARD_DELETE_CONFIG_SUCCESS(200, MessageCodeEnum.GENERIC_CODE_SUCCESS.getCodeString(), "Sucess to delete config %CONFIG% dashboard group entries", false, false, false, MessageGeneralEnum.DATA_OPERATION_SUCCESS),
    DASHBOARD_CREATE_ENTRY_SUCCESS(200, MessageCodeEnum.GENERIC_CODE_SUCCESS.getCodeString(), "Sucess to create dashboard entry for group %GROUP% and indicator %INDICATOR%", false, false, false, MessageGeneralEnum.DATA_OPERATION_SUCCESS),
    DASHBOARD_CREATE_GROUP_SUCCESS(200, MessageCodeEnum.GENERIC_CODE_SUCCESS.getCodeString(), "Sucess to create dashboard group %GROUP%", false, false, false, MessageGeneralEnum.DATA_OPERATION_SUCCESS),
    DASHBOARD_READ_SAVED_CONFIG_SUCCESS(200, MessageCodeEnum.GENERIC_CODE_SUCCESS.getCodeString(), "Sucess to read saved configurations for dashboard", false, false, false, MessageGeneralEnum.DATA_OPERATION_SUCCESS),
    DASHBOARD_CHECKER_SUCCESS(200, MessageCodeEnum.GENERIC_CODE_SUCCESS.getCodeString(), "Dashboard integrity is valid", false, false, false, MessageGeneralEnum.DATA_OPERATION_SUCCESS),
    ...
    DASHBOARD_READ_GROUP_SUCCESS(200, MessageCodeEnum.GENERIC_CODE_SUCCESS.getCodeString(), "Sucess to read dashboard group entries for config : %CONFIG%", false, false, false, MessageGeneralEnum.DATA_OPERATION_SUCCESS),
    ...
    DASHBOARD_SWITCH_CONFIG_SUCCESS(200, MessageCodeEnum.GENERIC_CODE_SUCCESS.getCodeString(), "Sucess to switch current config to %CONFIG%", false, false, false, MessageGeneralEnum.DATA_OPERATION_SUCCESS),
    ...
    DASHBOARD_CHECKER_FAILED(400, MessageCodeEnum.GENERIC_CODE_ERROR.getCodeString(), "Dashboard integrity is invalid cause %CAUSE%", false, false, false, MessageGeneralEnum.DATA_OPERATION_ERROR),
    DASHBOARD_CREATE_GROUP_FAILED(400, MessageCodeEnum.GENERIC_CODE_ERROR.getCodeString(), "Failed to create dashboard group %GROUP%", false, false, false, MessageGeneralEnum.DATA_OPERATION_ERROR),
    DASHBOARD_CREATE_ENTRY_FAILED(400, MessageCodeEnum.GENERIC_CODE_ERROR.getCodeString(), "Failed to create dashboard entry for indicator %INDICATOR% and group %GROUP%", false, false, false, MessageGeneralEnum.DATA_OPERATION_ERROR),
    DASHBOARD_DELETE_GROUP_FAILED(400, MessageCodeEnum.GENERIC_CODE_ERROR.getCodeString(), "Failed to delete dashboard group cause %CAUSE%", false, false, false, MessageGeneralEnum.DATA_OPERATION_ERROR),
    DASHBOARD_SWITCH_CONFIG_FAILED(400, MessageCodeEnum.GENERIC_CODE_ERROR.getCodeString(), "Failed to switch dashboard config cause : %CONFIG%", false, false, false, MessageGeneralEnum.DATA_OPERATION_ERROR),
    DASHBOARD_READ_GROUP_FAILED(400, MessageCodeEnum.GENERIC_CODE_ERROR.getCodeString(), "Failed to read dashboard group cause %CAUSE%", false, false, false, MessageGeneralEnum.DATA_OPERATION_ERROR),
    DASHBOARD_WEBSERVICE_ERROR(400, MessageCodeEnum.GENERIC_CODE_ERROR.getCodeString(), "Failed to request web service for %TARGET%, probably cause %CAUSE%, please contact your administrator", false, false, false, MessageGeneralEnum.DATA_OPERATION_ERROR),
    DASHBOARD_DELETE_CONFIG_FAILED(400, MessageCodeEnum.GENERIC_CODE_ERROR.getCodeString(), "Failed to delete config %CONFIG% cause %CAUSE%", false, false, false, MessageGeneralEnum.DATA_OPERATION_ERROR),
    ...
    DASHBOARD_NOT_EXISTING_CONFIG(400, MessageCodeEnum.GENERIC_CODE_ERROR.getCodeString(), "Failed to switch config cause  : %CONFIG% is not existing configuration", false, false, false, MessageGeneralEnum.DATA_OPERATION_ERROR),
    ...
    DASHBOARD_READ_SAVED_CONFIG_EMPTY(300, MessageCodeEnum.GENERIC_CODE_ERROR.getCodeString(), "Empty saved config list for dashboard", false, false, false, MessageGeneralEnum.DATA_OPERATION_ERROR),
